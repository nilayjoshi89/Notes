...
{
    public class ObserverDemo : IDemonstratePattern
    {
        public string Name => "Behavioral.Observer";

        public string ShortSummary => "Observer is a behavioral design pattern that allows some objects to notify other objects about changes in their state.";
